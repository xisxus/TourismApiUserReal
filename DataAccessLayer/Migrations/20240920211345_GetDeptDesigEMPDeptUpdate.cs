...
{
    /// <inheritdoc />
    public partial class GetDeptDesigEMPDeptUpdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            Alter PROCEDURE SP_GetAllDepartments
            AS
            BEGIN
            ...
            migrationBuilder.Sql(@"
            Alter PROCEDURE SP_GetDepartmentById
            @DepartmentId INT
            AS
            BEGIN
                SELECT DepartmentId, DeptName, Description, CreatedAt, UpdatedAt
            ...
            migrationBuilder.Sql(@"
            Alter PROCEDURE SP_GetDesignationById
            @DesignationId INT
            AS
            BEGIN
                SELECT DesignationId, DesignationTitle, CreatedAt, UpdatedAt
            ...
            // Employee-Department
            migrationBuilder.Sql(@"
            Alter PROCEDURE SP_GetAllEmpDepts
            AS
            BEGIN
            ...
            migrationBuilder.Sql(@"
            Alter PROCEDURE SP_GetEmpDeptById
            @EmpDeptId INT
            AS
            BEGIN
                SELECT EmpDeptId, EmployeeId, DepartmentId, CreatedAt, UpdatedAt
