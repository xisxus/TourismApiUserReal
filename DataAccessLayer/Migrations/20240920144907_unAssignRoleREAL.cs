...
{
    /// <inheritdoc />
    public partial class unAssignRoleREAL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                CREATE PROCEDURE UnassignRoleFromUser2
                ...
                BEGIN
                    ...
                    IF @RoleName = 'User'
                        BEGIN
                            SELECT -4 AS Status, 'Cannot unassign User role' AS Message;
                            RETURN;
                        END
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS UnassignRoleFromUser2");
        }
    }
}
