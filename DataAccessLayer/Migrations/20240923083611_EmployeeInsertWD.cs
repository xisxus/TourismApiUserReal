...
{
    /// <inheritdoc />
    public partial class EmployeeInsertWD : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                    CREATE TYPE dbo.NewEmployeeBankType AS TABLE
                    (
                ...
                ");
                        ...
                        migrationBuilder.Sql(@"
                    CREATE TYPE dbo.NewEmployeeSalariesType AS TABLE
                    (
                ...
                ");
                    ...
                    CREATE PROCEDURE dbo.InsertNewEmployee
                        ...
                        @EmployeeBank dbo.NewEmployeeBankType READONLY,
                        @EmployeeSalaries dbo.NewEmployeeSalariesType READONLY,
                    ...
                    BEGIN
                        ...
                        VALUES (@NewEmployeeId, @DepartmentId, SYSDATETIME(), SYSDATETIME(), 0);
                        ...
                        SELECT @NewEmployeeId, BankName, AccountNumber, BranchName, AccountType, SYSDATETIME(), SYSDATETIME(), 0 FROM @EmployeeBank;
                        ...
                        SELECT @NewEmployeeId, EffectiveDate, BaseSalary, Allowances, OvertimePay, Bonus, Deductions, SYSDATETIME(), SYSDATETIME(), 0 FROM @EmployeeSalaries;
                    END
                ");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.InsertNewEmployee;");

            // Drop table types
            migrationBuilder.Sql("DROP TYPE IF EXISTS dbo.NewEmployeeBankType;");
            migrationBuilder.Sql("DROP TYPE IF EXISTS dbo.NewEmployeeSalariesType;");
        }
    }
}
